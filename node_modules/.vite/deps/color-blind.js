...
// node_modules/color-blind/lib/blind.js
var require_blind = __commonJS({
  "node_modules/color-blind/lib/blind.js"(exports) {
    "use strict";
...
var require_color_blind = __commonJS({
  "node_modules/color-blind/lib/color-blind.js"(exports) {
    ...
    var createBlinder = function(key2) {
      return function(colorString, returnRgb) {
        ...
        }, colorVisionData[key2].type, colorVisionData[key2].anomalize);
        rgb.R = rgb.R || 0;
        rgb.G = rgb.G || 0;
        rgb.B = rgb.B || 0;
        if (returnRgb) {
...
export default require_color_blind();
//# sourceMappingURL=color-blind.js.map
